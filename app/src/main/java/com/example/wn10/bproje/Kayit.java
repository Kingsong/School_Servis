...
public class Kayit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OgrOkul = findViewById(R.id.Okul);
        OgrVakit = findViewById(R.id.Vakit);
        OgrAd = findViewById(R.id.Ad);
        OgrSoyad = findViewById(R.id.Soyad);
        OgrTelefon = findViewById(R.id.Telefon);
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Kayit.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Kayit.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    public void showLastKnownLocation() {
       ...
       if(okul.isEmpty())
       {
        ...
        Call<DefaultResponse> call = RetrofitClient
                .getInstance()
                .getApi()
                .createUser(lat,lng,okul,vakit,ad,soyad,telefon, SharedPrefManager.getInstance(Kayit.this).getPlaka());
        ...
        call.enqueue(new Callback<DefaultResponse>() {
            ...
            public void onResponse(Call<DefaultResponse> call, Response<DefaultResponse> response) {
                if (response.code() == 201) {
                    ...
                    Toast.makeText(Kayit.this, dr.getMsg(), Toast.LENGTH_LONG).show();

                } else if (response.code() == 422) {
                    Toast.makeText(Kayit.this, "User already exist", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<DefaultResponse> call, Throwable t) {
                Toast.makeText(Kayit.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
